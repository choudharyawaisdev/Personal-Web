...
if (isset($_POST['install'])) {
    ...
    try {
        ...
        if ($stmt_proj->fetchColumn() == 0) {
            ...
            // WordPress Projects
            $insert_proj->execute([
                'Sara Store - E-Commerce Store',
                'A full-featured WordPress & WooCommerce online store featuring customized product catalogs, instant checkout, payment gateways, and custom sales badges.',
                'sarastore.pk.jpg',
                'WordPress',
            ...
            $insert_proj->execute([
                'Hafiz Talha - Personal Brand & Portfolio',
                'Custom WordPress website designed with high performance, smooth animations, dynamic blog management, and optimized SEO structure.',
                'hafiztalha.com.jpg',
                'WordPress',
                'WordPress, PHP, MySQL, Elementor Pro',
                'https://hafiztalha.com/',
                null
            ]);
            $insert_proj->execute([
                'Boxwala - Custom Packaging & Store',
                'Modern WooCommerce platform engineered for custom packaging solutions, custom quotation forms, responsive catalog filtering, and bulk order management.',
                'boxwala.pk.jpg',
                'WordPress',
                'WordPress, WooCommerce, PHP, MySQL',
                'https://boxwala.pk/',
            ...
            $insert_proj->execute([
                'Looking Glass Academy - Educational Portal',
                'Comprehensive educational academy website with course enrollments, interactive curriculum showcases, event schedules, and contact lead capture.',
                'lookingglassacademy.net.jpg',
                'WordPress',
                'WordPress, PHP, MySQL, LMS Integration',
                'https://lookingglassacademy.net/',
                null
            ]);
            $insert_proj->execute([
                'HerbalCare - Natural Products Store',
                'Custom-designed herbal e-commerce website with product showcase, discount coupon system, order tracking, and multiple payment integrations.',
                'herbal-ecommerce-store.png',
                'WordPress',
                'WordPress, WooCommerce, PHP, MySQL',
                null,
                null
            ...
            // Laravel Projects
            $insert_proj->execute([
                'CoursePro - Online Learning & Course Platform',
                'High-performance online course & education management platform built with Laravel featuring student dashboards, course progress tracking, video streaming, and secure payments.',
                'coursepro.today.jpg',
                'Laravel',
                'PHP, Laravel, MySQL, REST APIs',
                'https://coursepro.today/',
                null
            ]);
            $insert_proj->execute([
                'Multi-Vendor E-Commerce Platform',
                'Enterprise multi-vendor e-commerce architecture allowing multiple sellers to register, manage inventory, process orders, and track payout analytics with an admin dashboard.',
                'ecommerce-multi-vendor-platform.png',
                'Laravel',
            ...
            $insert_proj->execute([
                'All-in-One LMS Education System',
                'Complete learning management portal for modern education with quizzes, assignments, certificate generation, attendance monitoring, and role-based permissions.',
                'learning-management-system-lms.png',
                'Laravel',
                'PHP, Laravel, MySQL, REST APIs',
                null,
                null
            ...
            $insert_proj->execute([
                'RestroHub - Restaurant POS & Order Management',
                'Complete restaurant POS solution with dine-in/takeaway order routing, live kitchen display system (KDS), delivery tracking, and revenue analytics.',
                'restaurant-management-pos-system.png',
                'Laravel',
            ...
            $insert_proj->execute([
                'Employee HRM & Payroll Management System',
                'All-in-one HR system managing employee records, real-time biometric attendance, automated salary slips, leave requests, and departmental performance tracking.',
                'employee-hrm-management-system.png',
                'Laravel',
                'PHP, Laravel, MySQL, MVC Architecture',
                null,
                null
            ]);
            ...
            // PHP Projects
            $insert_proj->execute([
                'Smart Inventory Management Software & ERP',
                'Real-time inventory tracking, warehouse multi-location management, sales & purchase invoicing, low-stock alerts, and financial reporting.',
                'inventory-management-software.png',
                'PHP',
                'Core PHP, MySQL, SQL Optimization, Bootstrap 5',
                null,
                null
            ]);
        }
